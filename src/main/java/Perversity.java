...
public class Perversity extends NewListener {
    ...
    public Perversity() throws IOException, ClassNotFoundException {
        super();
        try{
            ObjectInputStream in = new ObjectInputStream(new FileInputStream("botFiles/perversity.txt"));
    ...
    public void save() throws IOException {
        ObjectOutputStream output = new ObjectOutputStream(new FileOutputStream("botFiles/perversity.txt"));
